              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-100">
                    ...
                    <th className="px-4 py-3 text-[12px] font-medium cursor-pointer hover:bg-gray-800 transition-colors" onClick={() => toggleSort('name')}>
                    <div className="flex items-center gap-1">Name {sortBy === 'name' ? <ArrowUpDown size={12} className="text-gray-300"/> : <ArrowUpDown size={12} className="opacity-20"/>}</div>
                  </th>
                    <th className="px-4 py-3 text-[12px] font-medium w-32 cursor-pointer hover:bg-gray-800 transition-colors" onClick={() => toggleSort('status')}>
                    ...
                    <th className="px-4 py-3 text-[12px] font-medium w-32 cursor-pointer hover:bg-gray-800 transition-colors" onClick={() => toggleSort('default')}>
