...
const ScopeOfWorkListPage = () => {
  ...
  const load = async () => {
    ...
    try {
      ...
      const r = await api.get('/scope-of-works/paginated', { params });
      setItems(r.data.data || []);
      setTotal(r.data.total || 0);
    } catch (e) {
      console.error(e);
      toast.error('Failed to load Scope of Works');
    } finally {
      setLoading(false);
    }
  };
            ...
            <table className="w-full text-left text-[13px] whitespace-nowrap">
              ...
              <tbody className="divide-y divide-gray-50">
                {loading && page === 1 ? (
                  ...
                  <tr>
                    <td colSpan="6" className="px-4 py-8 text-center text-gray-400 text-sm">No Scope of Works found</td>
                  </tr>
                ) : (
...
export default ScopeOfWorkListPage;
